    ...
    <AdminNav>
        <div class="p-7">
            <div class="w-full flex justify-between">
                <h3 class="text-2xl font-medium">EDITAR PLATO DE COMIDA</h3>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="omt-8">
                    <button type="submit" class="px-5 py-2 bg-green-200 text-green-800 font-medium">ACTUALIZAR PLATO</button>
                </div>
            </form>
...
export default {
    ...
    mounted() {
        ...
        this.form.url_video = this.dish.url_video;
        this.form.ingredients = this.dish.ingredients;
        this.form.step_by_step = this.dish.step_by_step;
        this.form.description = this.dish.description;
        this.form.categories = this.dish.categories;
        this.form.country_id = this.countries.find((country) => country.id == this.dish.country_id);
    },
    ...
    methods: {
        ...
        submit() {
            this.form.post(route('dishes.update', this.dish), this.form, {
                preserveScroll: true,
